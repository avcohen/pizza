        ...
        return(
            <div className={s.root}>
                <div className={s.container}>
                    <form className={s.clientForm} onSubmit={this.handleSubmit} encType="multipart/form-data">
                        <label htmlFor="name">
                            Name
                        ...
                        <input type="file" name="photo" id="photo" accept="image/png" onChange={this.handleChange} />
                        <label htmlFor="url">
                            Link
                            <input type="text" name="url" value={this.state.url} onChange={this.handleChange} />
                        </label>
                        <input type="submit" value="Save" className={s.submitButton}/>
                        <input type="button" value="Close" onClick={this.props.closeModulo} className={s.submitButton}/>
                    </form>
                </div>
            </div>
        )
